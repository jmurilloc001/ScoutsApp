...
public class ProductController
{
    ...
    public List<Product> productsWhoseDateAfter( @RequestParam( name = "date-after-year" ) int year, @RequestParam( name = "date-after-month" ) int month,
            @RequestParam( name = "date-after-day" ) int day )
    {
    ...
    public List<Product> productsWhoseDateAfter( @RequestParam( "date" ) @DateTimeFormat( pattern = "yyyy-MM-dd" ) Date date )
    { //localhost:8080/products/date-after?date=2010-01-01
        return service.productsWithLastPurcharseAfter( date );
    }
    ...
    public List<Product> productsWhoseDateBefore( @RequestParam( "date" ) @DateTimeFormat( pattern = "yyyy-MM-dd" ) Date date )
    { //localhost:8080/products/date-after?date=2010-01-01
    ...
    public ResponseEntity<Object> updateSomeFields( @Valid @RequestBody Product product, BindingResult result, @PathVariable Long id )
    {
        ...
        {
            p.setLastpurchase( product.getLastpurchase() );
        }
